...
"""
Code Introduction:
    This code cleans the raw data downloaded from SDC.
Version History:
    Created: Fri Mar 22 17:10:53 2019
    Current: 
...
SIC_FF5             =   pd.read_excel("..\\datasets\\SIC\\SIC_FF.xlsx", \
                                      sheet_name="FF5")
SIC_FF10            =   pd.read_excel("..\\datasets\\SIC\\SIC_FF.xlsx", \
                                      sheet_name="FF10")
### Clean Data
...
Sample['GapDays_F2I'] \
                    =   (Sample['IssueDate']-Sample['FilingDate']).dt.days
Sample['GapDays_L2I'] \
                    =   (Sample['IssueDate']-Sample['LaunchDate']).dt.days
Sample['GapDays_F2L'] \
                    =   (Sample['LaunchDate']-Sample['FilingDate']).dt.days
...
## String Variables
Sample['CUSIP'].replace('nan','',inplace=True)
Sample['CUSIP_9digit'].replace('nan','',inplace=True)
...
IpoSeoNum                       =   IpoSeoNum_F.merge(right=IpoSeoNum_L,how='outer', \
                                               ...
                                               .merge(right=IpoSeoNum_I,how='outer', \
                                                      on=['QDate','IPO_Flag'])
IpoSeoNum.IPO_Flag.replace({'Yes': 'IPO','No': 'SEO'},inplace=True)
